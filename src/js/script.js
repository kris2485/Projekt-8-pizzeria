...

{
  ...
  class Product {
    ...
    initAccordion() {
      ...
      /* const clickableTrigger = thisProduct.element.querySelector(select.menuProduct.clickable); same reference at getElements */
  ...
  class Cart {
    ...
    update() {
      ...
      thisCart.totalPrice = thisCart.totalNumber * thisCart.subtotalPrice + deliveryFee;
